...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.checkmarked)
    {
        ...
        [checkmark drawInRect:CGRectMake(4, 9, width-8, height-8) withFont: [UIFont boldSystemFontOfSize:0.85f*width] lineBreakMode: NSLineBreakByTruncatingTail alignment: NSTextAlignmentCenter];
